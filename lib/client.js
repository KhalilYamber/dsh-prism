window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const STR_EN = {
      ...
      fabTitleEnd: ')',
      simple: 'Simple',
      simpleNote: 'Plain language, easier to read',
      medium: 'Medium',
      mediumNote: 'Native wording, grouped tool flow',
      native: 'Native',
      nativeNote: 'Full native interface',
    ...
    function nativeSummary(name, argsRaw) {
      ...
      const base = picked === undefined ? firstLineOf(argsRaw || '') : firstLineOf(picked);
    ...
    function NativeToolRow(props) {
      ...
      const collapsed = summary === '' ? null : React.createElement('span', { className: 'prism-native-meta' },
        ...
        React.createElement('span', { className: 'prism-native-summary', title: summary }, summary),
      );
    ...
    function apply(ctx) {
      ...
      function PrismControl(props) {
        ...
        const cur = mode === 'simple' ? t('simple') : t('native');
        const items = [
