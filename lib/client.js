window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function outcomeOf(root) {
      ...
      return code !== null && code !== 0 ? 'err' : 'ok';
    }
    ...
    function toolRowMeta(toolName, block) {
      ...
      const outcome = outcomeOf(settled ? block : null);
      const isError = outcome === 'err';
      const exitCode = settled && !(block.isError === true) ? exitCodeOf(text) : null;
      ...
      return { settled, name, argsRaw, isError, exitCode, text, rule, argPlain, plainLine, lineText, statusIcon, statusCls, statusWord, rowLabel, callTime, resultTime };
    }
    ...
    function makeNativeToolRow(useTick, useRowOpen, toggleRow) {
      ...
      const detail = React.createElement('div', {
        ...
        React.createElement('div', { className: 'prism-doc' },
          ...
          React.createElement(ArgsBlock, { argsRaw: meta.argsRaw, primitives: P }),
          (meta.settled && meta.text) ? React.createElement('div', { className: 'prism-doc-label' }, t('resultLabel')) : null,
    ...
    function apply(ctx) {
      ...
      function noteTurnSnap(turn, nodeKind, record) {
        try {
      ...
      function ToolCard(props) {
        ...
        return React.createElement('div', Object.assign(
          ...
          open ? React.createElement('div', {
            ...
            React.createElement('div', { className: 'prism-doc' },
              React.createElement('div', { className: 'prism-doc-name' }, name),
              React.createElement(ArgsBlock, { argsRaw: meta.argsRaw, primitives: primitives }),
