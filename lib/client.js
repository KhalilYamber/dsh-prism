  ...
  factory: (require) => {
    ...
    function markdownDoc(text) {
      try {
        ...
        flushPara();
        if (out.length === 0) {
          out.push(React.createElement('p', { key: nextKey(), className: 'prism-doc-p' }, '（无内容）'));
        }
        return out;
      } catch (e) {
    ...
    function apply(ctx) {
      ...
      function toggleGroup(turn) {
        var key = turn === null ? 'none' : turn;
      ...
      function useGroupOpen(turn) {
        const key = turn === null ? 'none' : turn;
        ...
        return React.createElement('div', {
          ...
          open ? React.createElement('div', {
            ...
            React.createElement('div', { className: 'prism-doc' },
              ...
              (settled && text) ? React.createElement('div', { className: 'prism-doc-label' }, '结果：') : null,
              // 结果必须先脱敏再渲染成交付文档
      ...
      function ToolGroupNode(props) {
        ...
        // useSession 是 framework 标准 hooks（session 作用域槽组件由
        // props 注入，见 runtime SessionStandardProps），不能裸用。
        const useSession = props.useSession;
        const turn = turnOf(node.location);
        const groupOpen = useGroupOpen(turn);
        ...
        if (!groupOpen) {
          ...
          return React.createElement('div', {
            ...
            onClick: function () { toggleGroup(turn); },
          },
            ...
            React.createElement('span', { className: 'prism-group-caret' }, '展开 ▾'),
          );
        }
        ...
        return React.createElement('div', { className: 'prism-group prism-group-panel' },
          React.createElement('div', {
            ...
            React.createElement('span', { className: 'prism-group-emoji', 'aria-hidden': true }, '🔧'),
            React.createElement('span', { className: 'prism-group-title' }, '本次调用 ' + countText),
            React.createElement('span', { className: 'prism-group-status ' + status.cls, 'aria-hidden': true }, statusText),
            React.createElement('span', { className: 'prism-group-caret' }, '收起 ▴'),
          ),
      ...
      function PrismControl(props) {
        ...
        return React.createElement('div', { className: 'prism-root', style: { left: pos.left, bottom: pos.bottom } },
          ...
          open ? React.createElement('div', { className: 'prism-menu', onClick: function (e) { e.stopPropagation(); } },
            React.createElement('div', { className: 'prism-menu-title' }, '界面模式'),
            ...
            React.createElement('div', { className: 'prism-menu-title' }, '简化档选项'),
            React.createElement('button', {
              type: 'button',
              ...
              React.createElement('span', { className: 'prism-menu-label' }, '隐藏复杂工具'),
